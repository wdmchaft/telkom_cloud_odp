 ...
 * Copyright (c) 2009-2011 by Telkom_Cloud, Inc. All Rights Reserved.
...
//@interface Telkom_CloudObject : NSObject
//@end

@interface Telkom_CloudObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Telkom_CloudObject class]])
		{
			for (NSString *key in [[(Telkom_CloudObject*)o modules] allKeys])
			{
