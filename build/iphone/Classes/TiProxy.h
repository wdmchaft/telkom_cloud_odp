...
//Rare exceptions to indicate a bug in the _telkom_cloud code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Telkom_Cloud proxies.
 */
