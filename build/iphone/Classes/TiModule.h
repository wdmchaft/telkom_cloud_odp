...
/**
 The base class for all Telkom_Cloud modules
 */
...
/**
 Telkom_Cloud Platform calls this method on startup.
 */
-(void)startup;

/**
 Telkom_Cloud Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Telkom_Cloud Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Telkom_Cloud Platform calls this method on resume.
 @param sender The sender of the event.
 */
