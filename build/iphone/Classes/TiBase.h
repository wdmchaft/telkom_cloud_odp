...
// in simulator we redefine to format for Telkom_Cloud Developer console
...
{\
	NSString * exceptionName = [@"org.telkom_cloud." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.telkom_cloud";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITelkom_CloudNativeItemNone = -1, 
	UITelkom_CloudNativeItemSpinner = -2,
	UITelkom_CloudNativeItemProgressBar = -3,
	
	UITelkom_CloudNativeItemSlider = -4,
	UITelkom_CloudNativeItemSwitch = -5,
	UITelkom_CloudNativeItemMultiButton = -6,
	UITelkom_CloudNativeItemSegmented = -7,
	
	UITelkom_CloudNativeItemTextView = -8,
	UITelkom_CloudNativeItemTextField = -9,
	UITelkom_CloudNativeItemSearchBar = -10,
	
	UITelkom_CloudNativeItemPicker = -11,
	UITelkom_CloudNativeItemDatePicker = -12,
	
	UITelkom_CloudNativeItemInfoLight = -13,
	UITelkom_CloudNativeItemInfoDark = -14,
	
	UITelkom_CloudNativeItemDisclosure = -15,
	
	UITelkom_CloudNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Telkom_Cloud instances of
