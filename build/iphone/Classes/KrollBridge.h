...
@interface Telkom_CloudObject : KrollCoverageObject {
#else
@interface Telkom_CloudObject : KrollObject {
#endif
@private
...
extern NSString * Telkom_Cloud$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Telkom_CloudObject *_telkom_cloud;
	BOOL shutdown;
